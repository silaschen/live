...
require_once "/var/www/movie/extend/api_sdk/vendor/autoload.php";
...
class Help
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIzN1TmdtycoOt"; // AccessKeyId

        $accessKeySecret = "PtwOKmgnfxpc50piLdl6rlSwPMpcEa"; // AccessKeySecret
    ...
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("陈四伟");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_140725802");
