<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"/var/www/movie/application/index/view/admin/login.html";i:1527083065;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong><?php echo \think\Config::get('APPNAME'); ?></strong>后台管理系统</h1>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                        	<p><a href="" title='智慧成就梦想!' style='color:#ccc;font-size:12px;'>&copy; <?php echo \think\Config::get('APPNAME'); ?></a></p>
