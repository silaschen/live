<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"/var/www/movie/application/index/view/index/selectshow.html";i:1527083065;s:53:"/var/www/movie/application/index/view/index/base.html";i:1527911933;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- AddThis Smart Layers END -->
	<div class="m-tickets-instantly">
		<h4>please to watch movie during the valid date,Don't forget the expire.</h4>
		...
		<div class="col-md-8 movies-dates">	
			...
			<div class="movie-date-selection">
				<ul>
					...
					<li class="location">
						<a><i class="fa fa-map-marker"></i><?php echo $da['name']; ?>: <?php echo $da['address']; ?>&nbsp<?php if($da['ablebuy'] == false): ?><span class="label label-danger">No validate</span><?php endif; ?></a>
					</li>
					<?php if(is_array($da['time']) || $da['time'] instanceof \think\Collection || $da['time'] instanceof \think\Paginator): if( count($da['time'])==0 ) : echo "" ;else: foreach($da['time'] as $key=>$v): if($da['ablebuy'] == true): ?>
					<li class="time">
