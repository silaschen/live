<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"/var/www/movie/application/index/view/index/payment.html";i:1527911933;s:53:"/var/www/movie/application/index/view/index/base.html";i:1527911933;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<input type="hidden" name="vid" value="<?php echo input('vid'); ?>">
<input type="hidden" name="time" value="<?php echo input('time'); ?>">
<input type="hidden" name="tid" value="<?php echo input('tid'); ?>">
		<div class="e-payment-section">
			<div class="col-md-8 payment-left">
				...
				<div class="confirm-details">
					...
					<input type="number" id="num" name="number" value="1" class="form-control"><?php echo $buyed; ?>/<?php echo $stock; ?>
...
<?php endif; ?>
						...
						<div id="tab4" class="tab-grid">
							<div class="row">
                        <div class="col-md-12">
                            <img class="pp-img" src="<?php echo \think\Config::get('WEBSERVER'); ?>/public/pay.png" alt="Image Alternative text" title="Image Title">
	...
	<!--start-carrer-->
		...
		<script>
			...
			<div class="payment-right">
				<h3>订单信息</h3>
				<h6><span>电影名称:</span><?php echo $film['title']; ?></h6>
				<p><span>电影院:</span> <?php echo $cinema['name']; ?> </p>
				<p><span>地址:</span> <?php echo $cinema['address']; ?></p>
				<p><span>日期:</span> <?php echo date("Y-m-d",$ticket['btime']); ?>---<?php echo date("Y-m-d",$ticket['etime']); ?></p>
				<p><span>放映时间:</span> <?php echo $time; ?></p>
				<p><span>座位:</span> 影院随机分配</p>
				<h4><span>共 :</span><?php echo $film['price']; ?></h4>
				<p>+ (平台服务费 : ￥. 1.00 )</p>
				<h5><span>共 :</span><span id="total"><?php echo $film['price']+1; ?>.00</span>￥</h5>
			</div>
...
function CheckTotal(){
	...
	$.post("<?php echo url('index/index/getTotal'); ?>",{'vid':vid,'num':num,'tid':tid,'time':time},function(ret){
		...
		function makeOrder(){
			...
			$.post('<?php echo url('index/index/orderfilm'); ?>',{'videoid':vid,'cinemaid':cid,'time':time,'ticketid':tid,'banknum':banknum,'bankname':bankname,'num':num},function(data){

					alert(data.msg);
					if(data.code === 1){

						location.href="<?php echo url('index/index/myticket'); ?>";
