<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"/var/www/movie/application/index/view/index/playonline.html";i:1527083065;s:53:"/var/www/movie/application/index/view/index/base.html";i:1527911933;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="row" style="margin:0;">
    <div class="col-md-8 col-sm-12">
          <div class="m">
              <video id="my-video" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="none"
                  poster="<?php echo \think\Config::get('WEBSERVER'); ?><?php echo $video['cover']; ?>"
                  data-setup="{}">
                <source src="<?php echo \think\Config::get('WEBSERVER'); ?>/public/uploads/love.mp4" type='video/mp4' />
    ...
    <?php if(is_array($recommend) || $recommend instanceof \think\Collection || $recommend instanceof \think\Paginator): if( count($recommend)==0 ) : echo "" ;else: foreach($recommend as $key=>$vo): ?>
        ...
        <a href="<?php echo url('index/index/playonline',array('id'=>$vo['id'])); ?>" class="list-group-item"><?php echo $vo['title']; ?></a>
