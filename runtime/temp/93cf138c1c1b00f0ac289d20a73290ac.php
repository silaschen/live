<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"/var/www/movie/application/index/view/index/blog.html";i:1527083065;s:53:"/var/www/movie/application/index/view/index/base.html";i:1527911933;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="blog-section">
		<div class="col-md-8 blog-posts">
			...
			<div class="blog-top">
			  ...
			  <div class="col-md-6 grid_3">
					<a href="<?php echo url('index/index/readblog',array('id'=>$vo['id'])); ?>"><img src="<?php echo \think\Config::get('WEBSERVER'); ?>/<?php echo $vo['cover']; ?>" class="img-responsive" alt=""></a>
					<div class="blog-poast-info">
						<ul>
							<li><i class="fa fa-user"></i><a class="admin" href="<?php echo url('index/index/readblog',array('id'=>$vo['id'])); ?>"><span> </span>cube</a></li>
							<li><i class="fa fa-calendar"></i><span> </span><?php echo date("Y-m-d",$vo['addtime']); ?></li>
							<li><i class="fa fa-comments"></i><a class="p-blog" href="#"><span> </span>3 评论 </a></li>
						</ul>
				    </div>
					<h3><a href="single.html"><?php echo $vo['title']; ?></a></h3>
					<p><?php echo $vo['desciption']; ?></p>
		...
		<div class="col-md-4 blog-categories">
			<h3 class="post">最热博客</h3>
			<?php if(is_array($hot) || $hot instanceof \think\Collection || $hot instanceof \think\Paginator): if( count($hot)==0 ) : echo "" ;else: foreach($hot as $key=>$hvo): ?>
			<p><a href="<?php echo url('index/index/readblog',array('id'=>$hvo['id'])); ?>"><?php echo $hvo['title']; ?></a></p>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
				<div class="clearfix"></div>
	</div>
