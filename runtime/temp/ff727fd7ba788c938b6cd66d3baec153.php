<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"/var/www/movie/application/index/view/index/myticket.html";i:1527086938;s:53:"/var/www/movie/application/index/view/index/base.html";i:1527911933;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="row">
    <div class="col-md-12 col-sm-12">
        ...
        <?php foreach($ticket as $vo): ?>
              <div class="panel panel-default">
                <div class="panel-heading">票价￥<?php echo $vo['money']; ?>X<?php echo $vo['num']; ?><span class="pull-right"> 有效期:<?php echo date('Y-m-d',$vo['btime']); ?>----<?php echo date("Y-m-d",$vo['etime']); ?></span></div>
                <div class="panel-body">
                  订单号:<?php echo $vo['orderid']; ?>
                  <?php echo $vo['title']; ?>  &nbsp  &nbsp<span class="label label-success">已支付</span>  <hr>
                  <?php echo $vo['name']; ?> &nbsp&nbsp<?php echo $vo['time']; ?>
                </div>
              </div>
